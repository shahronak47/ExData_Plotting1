...
plot(new_frame$DateTime, new_frame$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
plot(new_frame$DateTime, new_frame$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()
